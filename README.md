...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-eszns44.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-eszns44.containers.anotherwebservice.com/
...
```
git clone git@github.com:Dublin7/container-eszns44.git
cd container-eszns44
```
...
```
docker attach container-eszns44
```
